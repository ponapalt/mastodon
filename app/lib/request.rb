...
class Request
  ...
  def initialize(verb, url, **options)
    ...
    url = url.gsub('https://mastodon.lol', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://social.broti.net', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://m.servperso.net', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://cryptotooter.com', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://social.weho.st', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://fedi.astrid.tech', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://news.twtr.plus', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://bikeshed.party', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://praxis.nyc', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://forfuture.social', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://mental.camp', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://village.elrant.team', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://curbal.social', 'https://ukadon.shillest.net/gone')
    url = url.gsub('https://fedi.nano.lgbt', 'https://ukadon.shillest.net/gone')
